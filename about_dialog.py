...
class AboutDialog(QDialog):
    ...
    def _init_ui(self):
        ...
        <div style="font-size: 12pt; color: black;">
            Website: <a href="{self.website}" style="color: #000080; text-decoration: underline;">
                {self.website}
            </a>
        </div>
        """
        website_label = QLabel(website_html)
        website_label.setOpenExternalLinks(True)
        content_layout.addWidget(website_label, alignment=Qt.AlignCenter)
    
        # fit it all in the dialog
        self.adjustSize()

        # assure the dialog has focus
        self.setFocus()
    ...
    def paintEvent(self, event):
        ...
        background_color = QColor(162, 99, 240, int(255 * self.opacity))
